...
export type Lifecycle = components['schemas']['LifecycleResponse']
export type AuditEvent = components['schemas']['AuditEventResponse']
export type QueueStatus = components['schemas']['QueueResponse']
export type CloudGate = components['schemas']['CloudGateResponse']
